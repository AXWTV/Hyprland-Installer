...
show_menu() {
    ...
    echo "│ [2]  Install Hyprland Packages                       │"
    echo "│ [3]  Install Pipewire                                │"
    echo "│ [4]  Install AGS Hypr Packages                       │"
    echo "│ [5]  Install TMUX Plugins                            │"
    echo "│ [6]  Install NVIDIA Drivers                          │"
    echo "│ [7]  Install GTK Themes                              │"
    echo "│ [8]  Configure Bluetooth                             │"
    echo "│ [9]  Install & Configure SDDM                        │"
    echo "│ [10] Install XDG-DESKTOP-PORTAL-HYPRLAND             │"
    echo "│ [11] Install zsh, oh-my-zsh                          │"
    echo "│ [12] Install on ASUS ROG Laptops                     │"
    echo "│ [13] Clone repo and install pre-configured dotfiles  │"
    echo "│ [14] Install PowerLevel10K                           │"
    echo "│ [0]  Exit                                            │"
    echo "╰──────────────────────────────────────────────────────╯"
    echo -e "\e[0m"
}
...
while true; do
    ...
    case "$OPTION" in
        1)
            read -p "Type AUR helper (paru or yay): " aur_helper
            if [ "$aur_helper" == "paru" ]; then
                execute_script "paru.sh"
            elif [ "$aur_helper" == "yay" ]; then
                execute_script "yay.sh"
            else
                echo "Invalid AUR helper specified."
            fi
            ;;
        2)
